    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
        			  <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="did" value="<?php echo $depid ?>" Readonly>
		              </div>
        			  <div class="form-group">
		                  <label>Department Code</label>
		                  <input type="text" class="form-control" id="depcode" placeholder="Ex CCSE ..." value="<?php echo $depcode  ?>">
		              </div>
		              <!-- /.form-group -->
		              <div class="form-group">
		                  <label>Code Description</label>
		                  <input type="text" class="form-control" id="depdes" placeholder="Type here ..." value="<?php echo  $depdes?>">
		              </div>
		              <!-- /.form-group -->
		              <div class="form-group">
		              ...
		              <div class="col-sm-12 ">
                        ...
                        <img id="previewing" src="upload/<?php echo $deplogo; ?>" width="200" height="200" />
                  ...
                  <select class="form-control" id="depcover" >
                    <option><?php echo $depcover ?></option>
                  ...
                  <!-- /.form-group -->
		              <input type="submit" value="Update" class="btn btn-primary" id="button" />
...
$('#button').click(function() {
       ...
       if (r == true) {
              ...
              function callA() {
                  $.ajax({
                      type: 'POST',
                      url: 'php/updepartment.php',
                      data: { DID: did, Depcode: depcode, Depdes: depdes , Depcover: depcover , Eventfile: efile   },
                      success: function(response) {
