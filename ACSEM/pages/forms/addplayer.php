...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">MAIN NAVIGATION</li>
         ...
         <li class="active"><a href="apindex.php"><i class="fa fa-user-plus"></i> <span>Players</span></a></li>
  ...
  <div class="content-wrapper">
	...
	<!-- SELECT2 EXAMPLE -->
      <div class="box box-primary">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary" >
                    ...
                    if ($sportscat == "Men"){
                      ...
                      $query1 = "SELECT * FROM tbl_students where DepID = '$id3' And Sgender = '$gender'" ;
                      $result1 = mysqli_query($link, $query1);
                    }else if($sportscat == "Women"){
                      $gender = "Female";
                      $query1 = "SELECT * FROM tbl_students where DepID = '$id3' And Sgender = '$gender'" ;
                      $result1 = mysqli_query($link, $query1);
                    }else if ($sportscat == "Mix"){
                      $query1 = "SELECT * FROM tbl_students where DepID = '$id3'" ;
                      $result1 = mysqli_query($link, $query1);
                    }
                          ...
                          <td>
                          <?php
                           $query0 = "SELECT * FROM tbl_esplayers where EventID = '$id' AND DepID = '$id3' AND StudID = '$stud' AND SportsID = '$id2' " ;
                          ...
                          <button id="button" class="btn btn-primary" ><?php echo $holder ?></button>

                          </td>
                          <?php

                          $query00 = "SELECT * FROM tbl_esplayers where EventID = '$id' AND DepID = '$id3' AND StudID = '$stud' " ;
        ...
        <div class="box-footer">
            <input type="text" id="EID" name="EID" value="<?php echo $id?>" hidden>
            <input type="text" id="SID" name="SID" value="<?php echo $id2?>" hidden>
            <input type="text" id="DID" name="DID" value="<?php echo $id3?>" hidden>
        	
        	<a href="aplist.php?id=<?php echo $id;?>&id2=<?php echo $id2;?>"><button type="submit" class="btn btn-primary" >Done</button></a>
	...
	<div class="col-md-6"></div> <!--col2 End -->

	<div class="col-md-6"></div> <!--col3 End -->

	<div class="col-md-6"></div> <!--col4 End -->
      ...
      showInputs: false
                 ...
                 $("#mytable").on('click','.btn',function(){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'php/aplayer.php',
                            data: { EID: eid , DID: did, SID:sid, STID: col1 },
