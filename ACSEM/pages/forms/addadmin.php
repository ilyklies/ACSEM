  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin Entry</li>
      </ol>
    </section>
     ...
     <!-- SELECT2 EXAMPLE -->
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Admin Entry</h3>
        ...
        <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="aid" placeholder="First Name">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="amname" placeholder="First Name">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="alname" placeholder="First Name">
                    ...
                    <div class="form-group">
                          ...
                          <div class="input-group date">
                            ...
                            <input id="bdate" name="txtDateS" type="text" class="form-control pull-right" required>
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form-group -->
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="auname" placeholder="First Name">
                  ...
                  <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="apword" placeholder="First Name">
       ...
       if (r == true) {
              ...
              function callA() {
                  $.ajax({
                      ...
                      data: { Aid: aid , Afname: afname, Amname: amname , Alname: alname , Bdate: bdate , Agender: agender , Auname: auname , Apword: apword , Eventfile: efile   },
                      success: function(response) {
