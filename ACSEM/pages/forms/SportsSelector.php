    ...
    <section class="content">
    	...
    	<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Select Sports To Host</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="Select/SportsSelector.php">
              <div class="box-body">
                <div class="form-group">
                  <label >Event ID</label>
                  <input type="text" name="Eventid" class="form-control" value="<?php echo $id;?>"readonly >
                </div>
                <div class="form-group">
                  <label >Sports List</label>
                  <select class="form-control" name="Slist" required>
                  <option></option>
                  <?php
                   $query1 = "SELECT * FROM tbl_efacilitators Where EventID = '$id' And FacilitatorID = '$user1'" ;
    			         ...
    			         while($row = mysqli_fetch_assoc($result1)){
				                  ...
				                  while($row = mysqli_fetch_assoc($result1)){
				                  ?>
        				          <option><?php echo $row['SportsName'];?></option>
        				          <?php	
