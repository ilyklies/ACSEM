<?php 
 ...
 session_start();
  ...
  $evntid = $_SESSION['id'];
    ...
    $query0 = "SELECT * FROM tbl_event Where EventID = '$evntid'";
...
<div id="landing" class="container-fluid">
	...
	<div class="row">
	<div class="col-md-4">
	<h3>&nbsp;&nbsp;&nbsp;<?php echo $ename ;?> <small></small></h3>
	</div>
	...
	<div class="col-md-8 col-md-push-2 col-sm-8 col-sm-push-2 col-xs-8 col-xs-push-2 ">
		  ...
		  <div class="box box-info"  style="max-height:490px; min-height:490px; overflow-x: hidden;overflow-y:scroll hidden;">
		            ...
		            while($row = mysqli_fetch_assoc($result3)){
		                ...
		                while($row = mysqli_fetch_assoc($result)){
		                  ...
		                  <?php
		                      ...
		                      $query = "SELECT * FROM tbl_edepartments WHERE EventID = '$evntid'";
		                      $result = mysqli_query($link, $query);
		                      while($row = mysqli_fetch_assoc($result)){
                                  $depid = $row['DepID'];
                                  echo "<tr>";
                                  ...
                                  while($row = mysqli_fetch_assoc($result1)){
                                       ...
                                       $dcode = $row['Depcode'];
                                       $query2 = "SELECT * FROM tbl_sportpoints Where SportsID = '$sportsid' And EventID = '$evntid' And Depcode = '$dcode' ";
