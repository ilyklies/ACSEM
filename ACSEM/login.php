...
if((isset($_COOKIE['psd']) && $_COOKIE['psd'] != '')){
	$ps = $_COOKIE['psd'];
}else{
	$ps = "";
}
			  ...
			  <div class="login-box-body" style=" height:350px;opacity:0.9; ">
			    ...
			    <form id="login-form" action="LoginProcess.php" method="POST">
			      <div class="form-group has-feedback">
			        <input class="form-control" type="text" name="username" placeholder="ACSEM Username" value="<?php echo $user;?>">
			        <span class="glyphicon glyphicon-user form-control-feedback"></span>
			      </div>
			      <div class="form-group has-feedback">
			        <input  class="form-control" type="password" name="password" id="login-pass" placeholder="Password" value="<?php echo $ps;?>">
