     ...
     <!-- SELECT2 EXAMPLE -->
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Student Entry</h3>
        ...
        <div class="box-body">
                <div class="row">
                    ...
                    <form method="POST" action="php/addstudent.php">
                      ...
                      <input type="text" class="form-control" name="Sid" placeholder="School ID">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="Smname" placeholder="Middle Name">
                    ...
                    <!-- /.form-group -->
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="Sdep">
                          <option></option>
                          <?php
                          $query1 = "SELECT * FROM tbl_departments";
