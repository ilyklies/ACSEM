...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
              ...
              <p class="text-muted text-center">Facilitator</p>
              ...
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $fname ?>" id="ffname">
                    </div>
              </div>
               <div class="col-md-12">
                    <div class="form-group">
                        <label>Middlename</label>
                        <input type="text" class="form-control" value="<?php echo $mname ?>" id="fmname">
                    </div>
              </div>
               <div class="col-md-12">
                    <div class="form-group">
                        <label>Lastname</label>
                        <input type="text" class="form-control" value="<?php echo $lname ?>" id="flname">
                    </div>
              </div>
              <div class="col-md-12">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                          <div class="col-sm-12 ">  
                            <div id="image_preview" style="width:200; height:200;">
                              <img id="previewing" src="upload/<?php echo $Fphoto; ?>" width="200" height="200" />
                            </div>
                            <br>
  ...
  $(function () {
    ...
    $(".timepicker").timepicker({
      showInputs: false
                  ...
                  $.ajax({
                      type: 'POST',
                      url: 'uprofile/uprofile2.php',
                      data: { Aid: aid, Ffname: ffname , Fmname: fmname , Flname: flname , Abdate: abdate , Agender: agender , Auname: auname ,Apword: apword ,Eventfile: efile },
                      success: function(response) {
