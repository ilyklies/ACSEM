...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Department Team <small>Players</small>

      </h1>
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a>Departments Players</a></li>
    ...
    <div class="col-md-6">
        ...
        <div class="box" >
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $depcode; ?>  Team</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body" style="max-height: 350px; min-height: 350px; overflow-y: scroll;">
            ...
            <table class="table table-fixed">
                    ...
                    $query1 = "SELECT * FROM tbl_esplayers where EventID ='$id' AND DepID = '$depid' And SportsID = '$id2'" ;
                    $result1 = mysqli_query($link, $query1);
            ...
            <input type="text" name="SID" value="<?php echo $id2?>" hidden>
            <input type="text" name="DID" value="<?php echo $depid?>" hidden>
