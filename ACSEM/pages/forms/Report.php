        ...
        <div class="box-body">
          ...
          <div class="box box-primary">
		      <div class="box-header">
		         <h3 class="box-title">View Event Result</h3>
			    </div>
		      <!-- /.box-header -->
		      <div class="box-body table-responsive no-padding" style="max-height: 350px; min-height: 250px; overflow-y: scroll;">
                <table id="myTable1" class="table table-fixed">
		            ...
		            <?php 
			         ...
			         ?>
			         		<td><a href="ResultReport.php?id=<?php echo $eventid; ?>"><button id="bot1" class="btn btn-primary">View</button></a></td>
			         <?php
			         }
		             ?>    
		           </table>
          ...
          <div class="box box-primary">
          <div class="box-header">
             <h3 class="box-title">Student Sports Record</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding" style="max-height: 350px; min-height: 250px; overflow-y: scroll;">
                <table id="myTable1" class="table table-fixed">
                ...
                ?>
                  <td><a href="studreport.php?id=<?php echo $studid; ?>"><button id="bot1" class="btn btn-primary">View</button></a></td>
                <?php
               }
                 ?>    
               </table>
