  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Facilitator Entry</li>
      </ol>
    </section>
     ...
     <!-- SELECT2 EXAMPLE -->
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Facilitator Entry</h3>
                ...
                <div class="row">
	                   ...
	                   <div class="form-group">
			            ...
			            <div class="form-group">
			                  ...
			                  <input type="password" class="form-control" id="fpword" >
...
$('#button').click(function() {
       ...
       if (r == true) {
              ...
              function callA() {
                  $.ajax({
                      type: 'POST',
                      url: 'php/addfacilitator.php',
                      data: { Fid: fid , Ffname: ffname, Fmname: fmname , Flname: flname , Bdate: bdate , Fgender: fgender , Funame: funame , Fpword: fpword , Eventfile: efile   },
                      success: function(response) {
