<?php
 ...
 include("../../conn/checker2.php");
  ...
  while($row = mysqli_fetch_assoc($result))
   ...
   $query6 = "SELECT * FROM tbl_schedule Where MatchID = '$id'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-md-6">
            ...
            <!-- /.box-header -->
            <div class="box-body" style="max-height: 550px; min-height: 450px;">


            <form method="POST" action="php/deletesched.php">
            <div class="row">
            <div class="col-md-12">
            		<div class="form-group">
            		<label>Event ID</label>
            		<input type="text" class="form-control" name="Eventid" placeholder="Match ID" value="<?php echo $eventid ?>" readonly>
            		</div>
            		<div class="form-group">
            		<label>Match ID</label>
            		<input type="text" class="form-control" name="Matchid" placeholder="Match ID" value="<?php echo $id ?>" readonly>
            		</div>
            		<div class="form-group">
            		<label>Sports ID</label>
            		<input type="text" class="form-control" name="Sportsid" placeholder="Sports" value="<?php echo $sportsid ?>" readonly>
		            </div>
		            <div class="form-group">
		            <label>Venue</label>
		            		<input type="text" class="form-control" placeholder="Venue" value="<?php echo $venue ?>" readonly>
		            </div>
		            <div class="form-group">
		            <label>Date</label>
		            		<input type="text" class="form-control" placeholder="Date" value="<?php echo $date ?>" readonly>
		            </div>
            </div>
            </div>
            <div class="row">
            <div class="col-md-6">
            		<div class="form-group">
		            		...
		            		<input type="text" class="form-control" placeholder="StartTime" value="<?php echo $stime?>" readonly>
		            </div>
            </div>
            <div class="col-md-6">
            		<div class="form-group">
            				<label>End Time</label>
		            		<input type="text" class="form-control" placeholder="EndTime" value="<?php echo $etime ?>" readonly>
		            </div>
            </div>
            </div>
            <div class="row">
            <div class="col-md-6">
            		<div class="form-group">
            				<label>Team A</label>
		            		<input type="text" class="form-control" placeholder="TeamA" value="<?php echo $teama ?>" readonly>
		            </div>
            </div>
            <div class="col-md-6">
            		<div class="form-group">
            				<label>Team B</label>
		            		<input type="text" class="form-control" placeholder="TeamB" value="<?php echo $teamb ?>" readonly>
		            </div>
            </div>
            </div>
            		<div class="form-group">
            				<label>Match No</label>
		            		<input type="text" class="form-control" name="Matchno" placeholder="MatchNo" value="<?php echo $matchno ?>" readonly>
		            </div>
