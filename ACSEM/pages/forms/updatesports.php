<?php
  ...
  $query1 = "SELECT * FROM tbl_admin where AdminID = '$user'  " ;
  ...
  $sname = "";
  $srules = "";
  $query = "SELECT * FROM tbl_sports where SportsID = '$id' ";
  $result = mysqli_query($link, $query);
  while($row = mysqli_fetch_assoc($result)){

  		$sname = $row['SportsName'];
  		$srules = $row['SportsRules'];
  		$scat = $row['SportsCategory'];
  		$stype = $row['SportsType'];
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
              <form method="POST" action="php/upsports.php">
              <div class="form-group">
                
                  <label>Sports ID</label>
                  <input  type="text" class="form-control" name="sportsid"  id="search" value="<?php echo $id; ?>" placeholder="Type here ..." readonly>
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="sportsname" value="<?php echo $sname; ?>" placeholder="Type here ..." >
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="sportsrules"  placeholder="Type here ..."><?php echo $srules; ?></textarea>

              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <label>Sports Category </label>
                  <select class="form-control" name="sportscat" >
              ...
              <div class="form-group">
                <label>Sports Type</label>
                  <select class="form-control" name="sportstype" >
