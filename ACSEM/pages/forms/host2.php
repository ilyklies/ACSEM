            ...
            <div class="row">
                  <div class="col-md-7">
                            ...
                            <div class="box box-default" style="max-height: 750px; min-height: 350px;">
                                ...
                                <form action="php/gotohost2.php" method="POST">
                ...
                <tr> 
                 ...
                 <?php
                    ...
                    $result3 = mysqli_query($link, $query3);
                              ...
                              $query4 = "SELECT * FROM tbl_rank Where Depcode = '$depcode' And EventID = '$id' And SportsID = '$sportid' ";
                                     $result4 = mysqli_query($link, $query4);

                                     while($row = mysqli_fetch_assoc($result4)){
                                     	   echo "<td>" . $row['Depcode'] . "</td>";
                                     	   echo "<td>" . $row['Rank'] . "</td>";
                                     	   $points = $points + $row['Rank'];
                   ...
                   $("#tableFinal tr:gt(0)").each(function () {
                      ...
                      $.ajax({
                          ...
                          success: function(response) {
                               ...
                               $('#result').html(response);
                               window.location.replace("host2.php");
                          }
                      });
                     });
                }
